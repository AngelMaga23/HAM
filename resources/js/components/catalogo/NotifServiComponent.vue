    ...
    <h4 class="mb"> Registro</h4>
	  ...
	  <div class="col-md-6">
		...
		<label for="inputEmail3" class="col-sm-2 col-form-label">tipo</label>
		  <div class="col-sm-8">
		    <select v-model="nbTipoNotificacion" name="" id="" class="form-control">
		      <option :value="TipoN.id" :key="index" v-for="(TipoN,index) of TipoNotificacion">{{TipoN.nbTipoNotificacion}}</option>
		    </select>
		  </div>
	      </div>-->
	       <div class="form-group row">
